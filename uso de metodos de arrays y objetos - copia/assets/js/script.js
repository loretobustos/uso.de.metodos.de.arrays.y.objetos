...
//ejercicio 4
var Consultas = traumatologia.concat(radiologia, dental);
document.write('<h2>Total de consultas</h2>');
Consultas.forEach(function(c) {
    document.write(`<p>${c.paciente}</p>`);
});

//ejercicio 5
var Isapre = dental.filter(function(c) {
    if (c.prevision == 'ISAPRE')
        document.write(`<p> - ${c.paciente}: ${c.prevision}</p>`)
});

//ejercicio 6
var Fonasa = traumatologia.filter(function(c) {
